    ...
    <div id="cta" class="container-fluid container-xl px-2 px-sm-3 px-xxl-5 pb-5 text-light">
        <div class="d-flex flex-row bg-image rounded">
            ...
            <div class="col-6 py-5 mb-5">
                ...
                <p>Let's explore your use case and how we can help you reach your goals</p>
...
#cta {
    .bg-image {
        ...
        background: var(--arrow-bg-gradient-bottom-left-md), var(--arrow-bg-gradient-top-right-md), var(--bs-primary);
        max-height: 400px;
    }
    ...
    @media (min-width: 1200px) {
        .bg-image {
            background: var(--arrow-bg-gradient-bottom-left-xl), var(--arrow-bg-gradient-top-right-xl), var(--bs-primary);
        }
    }
}
</style>
